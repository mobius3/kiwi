 ...
 * \details First you need to create the SDL2 Renderer and the Window, and then
 * pass them to this function \param   renderer The SDL2 Renderer \param window
 * The SDL2 window \returns A KW_RenderDriver instance
 */
